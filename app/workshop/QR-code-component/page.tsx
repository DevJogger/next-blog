...
const page = () => {
  return (
    <div className="grid h-full w-full place-items-center after:fixed after:left-0 after:top-0 after:-z-10 after:h-lvh after:w-full after:bg-[#d5e1ef] after:content-[''] sm:bg-[#d5e1ef] sm:after:content-none">
